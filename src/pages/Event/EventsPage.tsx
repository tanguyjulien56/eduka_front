...
export default function EventsPage() {
  ...
  return (
    <div className="  flex flex-col-reverse gap-4 justify-start items-start mx-2  lg:grid grid-cols-3 ">
      <section className="col-span-2 pt-3  max-w-screen-xl mx-auto grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 ">
